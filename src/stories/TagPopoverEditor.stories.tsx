...
const openEditor = async (canvasElement: HTMLElement) => {
  ...
  // Generous timeouts: slow CI runners need extra time for the Dexie seed and
  // the popover portal to settle; findBy* returns as soon as the node exists.
  ...
  await body.findByText("Urgent", {}, { timeout: 10_000 })
}
