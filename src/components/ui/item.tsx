  ...
  "group/item flex w-full flex-wrap items-center rounded-md border text-xs/relaxed transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
        ...
        // Soft semantic tones — an accent border over a washed accent fill,
        // matching the app's status-tone formula (see utils/status-tone.ts).
        // The body text stays neutral; callers accent the icon/title.
        info: "border-blue-600/30 bg-blue-500/10 dark:border-blue-400/30 dark:bg-blue-400/10",
        success:
          "border-green-600/30 bg-green-600/10 dark:border-green-500/30 dark:bg-green-500/10",
        warning:
          "border-amber-600/30 bg-amber-500/10 dark:border-amber-400/30 dark:bg-amber-400/10",
        tip: "border-violet-600/30 bg-violet-500/10 dark:border-violet-400/30 dark:bg-violet-400/10",
        danger:
          "border-red-600/30 bg-red-500/10 dark:border-red-400/30 dark:bg-red-400/10",
      },
      size: {
